          ...
          >
            <div className="border-b border-border bg-muted px-4 py-2">
              <h3 className="font-medium text-foreground">
                {tc.name}
                {tc.id && (
                  <code className="ml-2 rounded bg-muted-foreground/10 px-2 py-1 text-sm">
                    {tc.id}
                  </code>
                )}
              </h3>
      ...
      <div className="border-b border-border bg-muted px-4 py-2">
        <div className="flex flex-wrap items-center justify-between gap-2">
          {message.name ? (
            <h3 className="font-medium text-foreground">
              Tool Result:{" "}
              <code className="rounded bg-muted-foreground/10 px-2 py-1">
                {message.name}
              </code>
            </h3>
          ) : (
      ...
      >
        ...
        {((shouldTruncate && !isJsonContent) ||
          ...
          <motion.button
            ...
            className="flex w-full cursor-pointer items-center justify-center border-t border-border py-2 text-muted-foreground transition-all duration-200 ease-in-out hover:bg-muted hover:text-foreground"
            initial={{ scale: 1 }}
