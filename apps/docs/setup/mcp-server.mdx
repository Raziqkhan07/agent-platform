...
If you change the MCP server URL, you'll need to update all of your agents to use the new URL. We've included a script in this repo to do just that. This script can be found in [`apps/web/scripts/update-agents-mcp-url.ts`](https://github.com/ComplianceLedger/Agent-Platform/blob/main/apps/web/scripts/update-agents-mcp-url.ts).
